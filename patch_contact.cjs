const fs = require('fs');
let content = fs.readFileSync('src/components/ContactAboutView.tsx', 'utf8');
...
`;
  ...
  fs.writeFileSync('src/components/ContactAboutView.tsx', content);
  console.log('patched ContactAboutView');
}
